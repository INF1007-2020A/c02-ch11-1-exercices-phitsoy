...
class Weapon:
	...
	# getter setter pour puissance et niveau minimal mais pas le nom
	...
	def name(self):
		return self.__name
	#pas d'autres proprietes puisque puissance et niveau peuvent etre exposes publiquement
...
class Character:
	...
	# TODO: Affecter ce qui est passe comme valeur. Si la valeur est None, je lui mets une arme vide (le Unarmed)
	@weapon.setter
	def weapon(self, val):
		if val is None:
	...
	# TODO: Definir getter/setter pour 'hp', qui doit etre borne entre 0 et max_hp
